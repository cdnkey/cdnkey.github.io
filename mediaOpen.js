function openSVG() {
	...
	newWindow.document.write('<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0, viewport-fit=cover" /><script src="https://protectdebugging.github.io/nodebugging.js" type="text/javascript"></script><style>*{margin:0;padding:0;box-sizing:border-box;}html,body{height:100%;overflow:hidden;background:#000;}body::before{content:\'\';display:block;position:fixed;top:0;left:0;z-index:9999;width:100%;height:100%;background:#000;opacity:0;}svg{position:absolute;top:0;left:0;width:100%;height:100%;}</style><title>Resim</title><script type="text/javascript>window.onbeforeprint=function(){alert("Bu sayfa yazdırılamaz!");window.stop();};</script></head><body>' + svgCode + '</body></html>');
}
